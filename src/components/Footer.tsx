          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-12">
            <div>
              ...
              <p className="text-muted-foreground mt-2 max-w-md">
                Co-founder and continuing informatics and computer science student with interests in full stack web and software development.
              </p>
            </div>
            ...
            <div className="flex flex-col items-end">
              <button 
                onClick={scrollToTop}
                className="p-3 bg-primary/10 rounded-full text-primary transition-all hover:bg-primary hover:text-white"
              ...
              <div className="mt-4 flex space-x-4">
                ...
                <a 
                  href="mailto:newtonbryan12428@gmail.com" 
                  className="text-foreground hover:text-primary transition-colors"
                  aria-label="Email"
                >
                  <svg 
